...
class StatsResponseSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["event_id", "event_source", "stats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stats": [StatsSchema.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None
        })
        return _obj
